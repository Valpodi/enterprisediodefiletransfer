...
TEST_CASE("ReorderPackets. Import diode.")
{
  ...
  SECTION("The first frame of wrapped data remains unchanged")
  {
    ...
    REQUIRE_FALSE(queueManager.write({HeaderParams{0, 1, false, {}}, wrappedInputStream.message}, &stream));
  ...
  {
    auto wrappedInputStream = createTestWrappedString("abc", {0x12, 0x34, 0x56, 0x78, static_cast<char>(0x9a), static_cast<char>(0xbc), static_cast<char>(0xde), static_cast<char>(0xf0)});
    queueManager.write({HeaderParams{0, 1, false, wrappedInputStream.header}, wrappedInputStream.message}, &stream);
    REQUIRE(outputStream.str() == std::string(wrappedInputStream.message.begin(), wrappedInputStream.message.end()));
    ...
    queueManager.write({HeaderParams{0, 2, false, wrappedInputStream2.header}, wrappedInputStream2.message}, &stream);
  ...
  SECTION("Two wrapped frames out of order are rewrapped with the key from frame with frameCount 1.")
  {
    ...
    queueManager.write({HeaderParams{0, 2, false, {}}, wrappedInputStream.message}, &stream);
    ...
    queueManager.write({HeaderParams{0, 1, false, {}}, wrappedInputStream2.message}, &stream);
  ...
  {
    auto wrappedInputStream = createTestWrappedString("abc", {0x12, 0x34, 0x56, 0x78, static_cast<char>(0x9a), static_cast<char>(0xbc), static_cast<char>(0xde), static_cast<char>(0xf0)});
    queueManager.write({HeaderParams{0, 1, false, {}}, wrappedInputStream.message}, &stream);
    auto wrappedInputStream2 = createTestWrappedString("def", {static_cast<char>(0xf0), 0x34, 0x56, 0x78, static_cast<char>(0x9a), static_cast<char>(0xbc), static_cast<char>(0xde), 0x12});
    queueManager.write({HeaderParams{0, 2, false, {}}, wrappedInputStream2.message}, &stream);
    ...
    queueManager.write({HeaderParams{0, 3, false, {}}, wrappedInputStream3.message}, &stream);
